var imagesLoaderBuilder = function() {
	var progress = document.createElement('progress');
	var loadedImages = {};
	var load = function(imagesToLoad, notify, baseurl) {

		var imagesArray = [];
		for ( var imageKey in imagesToLoad) {
			imagesArray.push({src:baseurl + imagesToLoad[imageKey],id:imageKey});
		}
...
loader.ressourceLoaded("imagesLoader");